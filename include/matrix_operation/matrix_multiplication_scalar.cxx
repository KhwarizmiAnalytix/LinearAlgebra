...
// Portable scalar/vectorized fallback backend — always compiled in and
// registered as the scalar dispatch_stub slot, regardless of which other
// backends (mkl / blas_lapack / cublas) are also enabled in this build.
...
LINALG_REGISTER_DISPATCH(matmul_f32_stub, scalar, matmul_scalar_f32);
LINALG_REGISTER_DISPATCH(matmul_f64_stub, scalar, matmul_scalar_f64);
